package com.jayden.io.nio.client;
...
public class NIOClient {
    ...
    private static final InetSocketAddress SERVER_ADDRESS = new InetSocketAddress("127.0.0.1", 9090);
